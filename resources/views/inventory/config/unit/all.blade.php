	...
	<div id="d-tambahunit" class="dialog" data-role="dialog">
		...
		<form action="{{route('unit.save')}}" method="POST">
			...
			<div class="dialog-actions text-right">
				<a href="{{route('unit.all')}}" class="button js-dialog-close alert">Batalkan</a>
				<button type="submit" class="button primary js-dialog-close info" onclick="Metro.notify.create('Unit Berhasil Ditambahkan', 'Tambah Unit', {keepOpen: false});">Tambahkan</button>
			</div>
		</form>
	</div>
</div>
