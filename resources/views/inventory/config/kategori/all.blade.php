	...
	<div id="d-tambahKategori" class="dialog" data-role="dialog">
		...
		<form action="{{route('kategori.save')}}" method="POST">
			...
			<div class="dialog-actions text-right">
				<a href="{{route('kategori.all')}}" class="button js-dialog-close alert">Batalkan</a>
				<button type="submit" class="button primary js-dialog-close info" onclick="Metro.notify.create('Kategori Berhasil Ditambahkan', 'Tambah Kategori', {keepOpen: false});">Tambahkan</button>
			</div>
		</form>
	</div>
</div>
