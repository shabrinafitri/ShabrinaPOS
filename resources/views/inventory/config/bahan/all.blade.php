	...
	<div id="d-tambahbahan" class="dialog" data-role="dialog">
		...
		<form action="{{route('bahan.save')}}" method="POST">
			...
			<div class="dialog-actions text-right">
				...
				<button type="submit" class="button primary js-dialog-close info" onclick="Metro.notify.create('Bahan Berhasil Ditambahkan', 'Tambah Bahan', {keepOpen: false});"></span>&nbsp;Tambahkan</button>
			</div>
		</form>
	</div>
</div>
